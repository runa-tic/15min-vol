...
These steps build a self-contained console binary. Run them from the repo root on macOS:
...
6. Package for sharing:
   ...
   ```
   Distribute `tge-volume-mac.zip`; end users can unzip and run the binary from Terminal.
